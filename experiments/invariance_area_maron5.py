...
from models.area5_small import GroupInvariance, SimpleNet, Conv1d, SegmentNet, GroupInvarianceConv, Maron, MessagePassing
...
def main(args):
    # 1. Get datasets
    train_ds, train_size = scenarios.area5_dataset(args.scenario_path)
    val_ds, val_size = scenarios.area5_dataset(args.scenario_path.replace("train", "val"))
